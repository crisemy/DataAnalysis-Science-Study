...
# ndim: number of dimensions (dimensionality)
...
#######################
# Solving Two Unknowns Equations with NumPy
#######################
...
# Objective: We want to access the information of each employee's manager.
...
# Naming X axis
plt.xlabel("Naming X axis")

plt.ylabel("Naming Y axis")
...
# Positioning Three Plots in One Row and Three Columns
# plot 1
x = np.array([80, 85, 90, 95, 100, 105, 110, 115, 120, 125])
y = np.array([240, 250, 260, 270, 280, 290, 300, 310, 320, 330])
plt.subplot(1, 3, 1)
...
# Let's try it on a dataset with more than 300 variables of approximately 600 megabytes.
